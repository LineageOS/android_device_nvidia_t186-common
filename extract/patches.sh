...
function chmod_tegraflash_t186() {
  ...
  find ${LINEAGE_ROOT}/${OUTDIR}/t186/r32/tegraflash -type f -exec chmod 755 {} \;
...
function patch_tegrasign_v3_t186() {
  ...
  sed -i "s|current_dir_path + '/|'|" ${LINEAGE_ROOT}/${OUTDIR}/t186/r32/tegraflash/tegrasign_v3_internal.py
  sed -i "/current_dir_path/d" ${LINEAGE_ROOT}/${OUTDIR}/t186/r32/tegraflash/tegrasign_v3_internal.py
